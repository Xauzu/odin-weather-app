...
export async function geocoding(location, cfg) {
...
export function calculateCondition(currentCondition, newCondition) {
    let results;
...
export function parseForecastData(response) {
...
export async function getForecast(lat, lon, cfg) {
    let data = []
    try {
